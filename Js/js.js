...
const expresiones = {
    asunto: /^[a-zA-Z0-9\_\-]{4,16}$/, // AQUI LE ESTAMOS DICIENDO QUE EN EL CAMPO USUARIO ACEPTE LETRAS MINUSCULAS Y MAYUSCULAS DE LA A HASTA LA Z, NÚMEROS DEL 0 HASTA EL 9, GUIONES BAJOS, GUIONES MEDIO Y UNA CANTIDAD MINIMA DE 4 CARACTERES Y MAXIMA DE 16 CARACTERES
...
$formulario.addEventListener("submit", (e) => {
    ...
    if(campos.asunto && campos.nombre && campos.correo && campos.telefono && $terminos.checked) {
        // formulario.reset();
